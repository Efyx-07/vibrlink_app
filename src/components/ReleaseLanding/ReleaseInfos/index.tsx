...
export default function ReleaseInfos({ release }: ReleaseInfosProps) {
  return (
    <div className="sticky top-40 z-20 flex min-h-20 w-full flex-col justify-center gap-1 bg-whiteColor p-2 text-center text-darkColor md:relative md:top-0 md:bg-transparent md:p-0 md:text-left md:text-whiteColor">
